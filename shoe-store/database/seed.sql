...
VALUES
  ...
  ('court-classic-low', 'Solely Court Low', 'Mục đích: sneaker trắng tối giản cho đi học, đi làm và phối đồ hằng ngày. Da tổng hợp dễ vệ sinh, đế cao su bền, độ bám ổn trên nền phố. Phù hợp khách muốn một đôi gọn, sạch và dễ mặc.', 'Solely', 'sneakers', 'unisex', 1590000, 'active', true),
  ('trail-guard-pro', 'Solely Trail Guard', 'Mục đích: trekking cuối tuần, đi rừng nhẹ và đường mòn khô. Độ bám cao, mũi giày gia cố, thân giày chắc và đệm vừa phải để giữ ổn định. Phù hợp khách hỏi giày leo núi, trail hoặc outdoor.', 'Solely', 'trail', 'men', 2490000, 'active', false),
  ('studio-flex-slip-on', 'Solely Studio Slip-On', 'Mục đích: tập gym nhẹ, yoga, đi bộ ngắn và di chuyển nhanh trong ngày. Thân slip-on co giãn, đệm mềm, form rộng thoải mái. Phù hợp nữ cần giày dễ xỏ, nhẹ chân, không ưu tiên chạy dài.', 'Solely', 'training', 'women', 1390000, 'active', false),
  ('heritage-leather-boot', 'Solely Leather Boot', 'Mục đích: đi làm, đi chơi cuối tuần và phối đồ smart casual. Da phủ mềm, cổ đệm êm, đế cao su bám chắc khi trời se lạnh. Phù hợp khách nam cần boot bền, lịch sự, không dùng cho leo núi kỹ thuật.', 'Solely', 'boots', 'men', 3290000, 'active', true),
  ('cloud-step-walker', 'Solely Cloud Walker', 'Mục đích: đi bộ nhiều, du lịch, đứng lâu và sinh hoạt hằng ngày. Đệm foam mềm, form rộng, cổ giày êm để giảm mỏi bàn chân. Phù hợp khách ưu tiên sự thoải mái hơn tốc độ hoặc phong cách thể thao mạnh.', 'Solely', 'walking', 'women', 1790000, 'active', false),
  ('metro-suede-high', 'Solely Suede High', 'Mục đích: sneaker cổ cao cho streetwear, đi học và đi chơi. Chất liệu suede mềm, cổ giày nâng đỡ nhẹ, đế phẳng ổn định. Phù hợp khách muốn phong cách nổi bật, không phải lựa chọn tối ưu cho chạy bộ.', 'Solely', 'sneakers', 'men', 2090000, 'active', false),
  ('rain-ready-chelsea', 'Solely Chelsea Rain', 'Mục đích: đi mưa nhẹ, đi làm và di chuyển trong phố. Thân boot chống nước nhẹ, quai kéo tiện, đế vân bám trên nền ướt. Phù hợp khách cần giày lịch sự khi trời mưa, không dành cho trekking dài.', 'Solely', 'boots', 'women', 2990000, 'active', true),
  ('summit-grip-hiker', 'Solely Summit Grip', 'Mục đích: leo núi nhẹ, trekking dốc vừa và đường đá nhỏ. Đế gai sâu, gót khóa chắc, mũi chống va đập và upper chống bám bẩn. Phù hợp khách cần độ bám tốt hơn sneaker khi đi outdoor cuối tuần.', 'Solely', 'trail', 'unisex', 2790000, 'active', true),
  ('riverstone-trek-mid', 'Solely Riverstone Mid', 'Mục đích: đi rừng, trekking đường ẩm và cắm trại. Cổ mid hỗ trợ mắt cá, vật liệu chống nước nhẹ, đế bám bùn tốt. Phù hợp khách hỏi giày leo núi ổn định, cần bảo vệ chân hơn mẫu cổ thấp.', 'Solely', 'trail', 'men', 3090000, 'active', false),
  ('campus-comfort-knit', 'Solely Campus Knit', 'Mục đích: đi học, đi làm casual và đi chơi cả ngày. Knit mềm thoáng, đệm êm vừa, form dễ mang với tất mỏng. Phù hợp khách muốn sneaker nhẹ, giá dễ tiếp cận, ưu tiên thoải mái hơn chống nước.', 'Solely', 'sneakers', 'unisex', 1490000, 'active', true),
  ('gym-core-trainer', 'Solely Gym Core', 'Mục đích: tập gym, cardio nhẹ, squat cơ bản và lớp fitness. Đế phẳng ổn định, thân giày giữ chân chắc, đệm phản hồi vừa. Phù hợp khách cần giày training đa dụng, không chuyên cho chạy đường dài.', 'Solely', 'training', 'unisex', 1990000, 'active', true),
  ('tempo-racer-lite', 'Solely Tempo Lite', 'Mục đích: chạy bộ 5km, đi bộ nhanh và tập cardio ngoài trời. Đệm nhẹ, upper thoáng, đế chuyển bước linh hoạt. Phù hợp khách muốn giày chạy êm hơn sneaker thường nhưng không cần carbon plate.', 'Solely', 'running', 'men', 2290000, 'active', false),
  ('commute-water-repel', 'Solely Commute Guard', 'Mục đích: đi làm hằng ngày, di chuyển xe máy và gặp mưa nhẹ. Bề mặt phủ kháng nước, đế bám nền ướt, form gọn dễ phối quần dài. Phù hợp khách cần sneaker sạch, thực dụng, không quá thể thao.', 'Solely', 'sneakers', 'unisex', 2190000, 'active', false),
  ('office-soft-loafer', 'Solely Office Soft', 'Mục đích: đi làm văn phòng, gặp khách và di chuyển ít trong ngày. Thân giả da mềm, lót êm, form lịch sự nhưng nhẹ hơn giày tây. Phù hợp khách cần đôi giày nhã nhặn, không dùng cho vận động mạnh.', 'Solely', 'walking', 'men', 1890000, 'active', false),
  ('court-flex-tennis', 'Solely Court Flex', 'Mục đích: tennis phong trào, pickleball và vận động ngang trên mặt sân. Đế cao su bám sân, thân giày ôm chắc, hông giày gia cố. Phù hợp khách hỏi giày court, cần ổn định hơn running shoe.', 'Solely', 'tennis', 'women', 2390000, 'active', false),
  ('street-basket-high', 'Solely Basket High', 'Mục đích: bóng rổ phong trào và phối đồ cổ cao. Cổ giày đệm dày, đế bám sân trong nhà, thân giày giữ chân khi đổi hướng. Phù hợp khách cần hỗ trợ cổ chân, không dùng cho trekking hoặc chạy dài.', 'Solely', 'basketball', 'men', 2690000, 'active', true),
  ('recovery-slide-soft', 'Solely Recovery Slide', 'Mục đích: đi sau tập luyện, đi trong nhà, ra phố gần và phục hồi bàn chân. Đệm EVA mềm, quai ôm nhẹ, đế chống trượt cơ bản. Phù hợp khách cần dép thể thao êm, không thay thế giày chạy.', 'Solely', 'walking', 'unisex', 790000, 'active', false),
  ('monsoon-trail-shield', 'Solely Monsoon Trail', 'Mục đích: trekking trời ẩm, đường đất ướt và du lịch vùng núi. Upper kháng nước, đế gai bám tốt, lưỡi gà che bụi. Phù hợp khách cần giày trail chống trơn, ưu tiên an toàn hơn vẻ thời trang.', 'Solely', 'trail', 'women', 2890000, 'active', true),
  ('daily-suede-classic', 'Solely Daily Suede', 'Mục đích: đi chơi, cafe, đi học và phối đồ tối giản. Suede mềm, đế cao su phẳng, màu trung tính dễ phối. Phù hợp khách cần sneaker đẹp, êm vừa, không ưu tiên chống nước hay vận động cường độ cao.', 'Solely', 'sneakers', 'women', 1790000, 'active', true);

INSERT INTO product_images (product_id, image_url, alt_text, sort_order)
SELECT p.id, data.image_url, data.alt_text, 1
FROM products p
JOIN (
  VALUES
...
) AS data(slug, image_url, alt_text) ON p.slug = data.slug;

INSERT INTO product_variants (product_id, sku, size, color, stock_quantity, discount_percent)
SELECT p.id, data.sku, data.size, data.color, data.stock_quantity, data.discount_percent
FROM products p
JOIN (
  VALUES
...
) AS data(slug, sku, size, color, stock_quantity, discount_percent) ON p.slug = data.slug;
